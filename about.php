...
<?php include("companents/navbar.php") ;?>
	<div class="container form mb-5">
		...
		<h1 class="display-4">Emir ÖZTÜRK</h1>
    ...
    <div class="center centerY " id="contact">
	
	<div class="container row center dark-text ">
		<div class="form col card-contact me-5">
			...
			<div class="box center-icons" >
                ...
                <p class="lead ms-5">some other 2 people idk</p></div>
			</div>
           

			
		</div>
		<div class=" form col card-contact ms-5">
